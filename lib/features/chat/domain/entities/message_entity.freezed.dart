...
mixin _$MessageEntity {
 ...
 String get id; String get senderId; String get senderName; String get message; DateTime get createdAt;
...
@override
int get hashCode => Object.hash(runtimeType,id,senderId,senderName,message,createdAt);

@override
String toString() {
  return 'MessageEntity(id: $id, senderId: $senderId, senderName: $senderName, message: $message, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String senderId, String senderName, String message, DateTime createdAt
});
...
/// Create a copy of MessageEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? senderId = null,Object? senderName = null,Object? message = null,Object? createdAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String senderId,  String senderName,  String message,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MessageEntity() when $default != null:
return $default(_that.id,_that.senderId,_that.senderName,_that.message,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String senderId,  String senderName,  String message,  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _MessageEntity():
return $default(_that.id,_that.senderId,_that.senderName,_that.message,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String senderId,  String senderName,  String message,  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _MessageEntity() when $default != null:
return $default(_that.id,_that.senderId,_that.senderName,_that.message,_that.createdAt);case _:
  return null;
...
class _MessageEntity implements MessageEntity {
  const _MessageEntity({required this.id, required this.senderId, required this.senderName, required this.message, required this.createdAt});
...
/// Create a copy of MessageEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? senderId = null,Object? senderName = null,Object? message = null,Object? createdAt = null,}) {
